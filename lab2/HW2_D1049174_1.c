...
int simple_init(void){
    ...
    person->id=kmalloc(sizeof("D1000001"), GFP_KERNEL);
    strcpy(person->id, "D1000001");
    ...
    person2->id=kmalloc(sizeof("D1000002"), GFP_KERNEL);
    strcpy(person2->id, "D1000002");
    ...
    person3->id=kmalloc(sizeof("D1000003"), GFP_KERNEL);
    strcpy(person3->id, "D1000003");
    person3->class=kmalloc(sizeof("IECS C"), GFP_KERNEL);
    strcpy(person3->class, "IECS C");
    ...
    person4->id=kmalloc(sizeof("D1000004"), GFP_KERNEL);
    strcpy(person4->id, "D1000004");
    person4->class=kmalloc(sizeof("IECS D"), GFP_KERNEL);
    strcpy(person4->class, "IECS D");
    ...
    person5->id=kmalloc(sizeof("D1000005"), GFP_KERNEL);
    strcpy(person5->id, "D1000005");
    person5->class=kmalloc(sizeof("IECS E"), GFP_KERNEL);
    strcpy(person5->class, "IECS E");
